<?php 
    ...
    function getCustomersElementsExtraction($login){
        require("../db/db_connect.php");
        $id = getLoginId($login);
        
        $req_extract = mysqli_query($db, "select M.name, E.quantity from mendeleiev M, customerextraction E where E.element=M.Z and E.Customer='$id'");
        if(!$req_extract){
